...
task_list = {'eat apple', 'drink water', 'go gym', 'rest', 'eat food'}
...
addTask_btn = Button(button_frame, text='Add Task', font=('times 24'), bg='#c5f776', padx=20, pady=10, command=newTask)
